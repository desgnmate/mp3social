            ...
            >
              ...
              <div className="relative z-[1] grid min-h-[inherit] gap-8 p-5 sm:p-8 lg:grid-cols-12 lg:p-10">
                <div className="flex min-w-0 flex-col justify-between lg:col-span-8">
                  <p data-hero-reveal className="fresh-eyebrow max-w-max rounded-full border border-warm-white/65 bg-warm-white/10 px-4 py-2 text-[0.6875rem] font-bold uppercase tracking-[0.12em] backdrop-blur-md">
                    {eyebrow}
                  </p>
